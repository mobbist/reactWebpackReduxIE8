...
function testFun() {
    ...
    return function (dispatch) {
        ...
        return abc().then(function (response) {
            dispatch(response);
        });
    };
}
...
//redux相应引用
var configureStore = __webpack_require__(171);
...
var Entry = function (_React$Component) {
    ...
    function Entry() {
        ...
        return _possibleConstructorReturn(this, (_ref = Entry.__proto__ || Object.getPrototypeOf(Entry)).call.apply(_ref, [this].concat(args)));
    }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(54), __webpack_require__(186).setImmediate))
...
var Container = function (_React$Component) {
    ...
    function Container() {
        ...
        return _possibleConstructorReturn(this, (_ref = Container.__proto__ || Object.getPrototypeOf(Container)).call.apply(_ref, [this].concat(args)));
    }

    _createClass(Container, [{
        key: 'clickFun',
        value: function clickFun() {
            this.props.testFun();
        }
    }, {
        key: 'render',
